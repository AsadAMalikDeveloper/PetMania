...
public class DoctorsMainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setFragment(new DoctosrHomeFragment(), homeFragmentNo);
        setRating();
        navigationDrawer();
        HashMap<Object,String> userMap = new HashMap<>();
        userMap.put("id", String.valueOf(Common.currentDoctor.getId()));
        ...
        reference.child(String.valueOf(Common.currentDoctor.getId())).setValue(userMap);
        FirebaseInstanceId.getInstance()
                .getInstanceId().addOnFailureListener(e -> {
            Toast.makeText(this, "fail", Toast.LENGTH_SHORT).show();
        }).addOnCompleteListener(task -> {
            Common.updateDrToken(DoctorsMainActivity.this,task.getResult().getToken());
        });
    }
