...
public class CatApiBreed {
    ...
    String id,name,cfa_url,vetstreet_url,vcahospitals_url,temperament,origin,
            country_codes,country_code,description,life_span,indoor,alt_names,wikipedia_url;
    int lap,adaptability,child_friendly,dog_friendly,energy_level,grooming,
    ...
    public CatApiBreed(String id, String name, String cfa_url, String vetstreet_url, String vcahospitals_url, String temperament, String origin, String country_codes, String country_code, String description, String life_span, String indoor, String alt_names, String wikipedia_url, int lap, int adaptability, int child_friendly, int dog_friendly, int energy_level, int grooming, int health_issues, int intelligence, int shedding_level, int social_needs, int stranger_friendly, int vocalisation, int experimental, int hairless, int natural, int rare, int rex, int suppressed_tail, int short_legs, int hypoallergenic, Weight weight) {
        this.id = id;
        this.name = name;
